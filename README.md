...
|------|-------------------|---------------------|
| 前端 | React + TypeScript + Vant UI | Qt 6 Widgets (C++17) |
...
docs/
    ...
    product/          # 产品文档
src/                  # 前端代码（Phase 1 开始）
supabase/             # Supabase 配置（Phase 1 开始）
README.md
.gitignore
```
...
开发环境搭建参见 [环境配置指南](docs/architecture/environment-setup.md)。
